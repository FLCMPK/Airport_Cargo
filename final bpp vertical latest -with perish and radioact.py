...
# Different Bin sub set, Bin Cut specification, fragility, Supporting Vertex has not been implemented in the code
...
# Items - bin type compatibility is not used in our case, still lacks fragility type
I = {1:{'L':4,'H':2,'rotation':1,'bin_types':[0,1],'perishable':1,'radioactive':0},
    2:{'L':2,'H':3,'rotation':1,'bin_types':[0,1],'perishable':1,'radioactive':0}, 
    3:{'L':2,'H':5,'rotation':0,'bin_types':[0],'perishable':1,'radioactive':0}, 
    4:{'L':5,'H':1,'rotation':1,'bin_types':[0],'perishable':1,'radioactive':0},
    5:{'L':3,'H':3,'rotation':1,'bin_types':[0,1],'perishable':1,'radioactive':0},
    6:{'L':3,'H':2,'rotation':1,'bin_types':[0,1],'perishable':0,'radioactive':0},
    7:{'L':2,'H':3,'rotation':1,'bin_types':[0,1],'perishable':1,'radioactive':0},
    8:{'L':5,'H':2,'rotation':1,'bin_types':[0,1],'perishable':1,'radioactive':0},
    9:{'L':3,'H':1,'rotation':0,'bin_types':[0],'perishable':0,'radioactive':0},
    10:{'L':2,'H':1,'rotation':1,'bin_types':[0,1],'perishable':0,'radioactive':0},
    11:{'L':5,'H':1,'rotation':1,'bin_types':[0,1],'perishable':1,'radioactive':0},
    12:{'L':4,'H':3,'rotation':0,'bin_types':[1],'perishable':0,'radioactive':1},
    13:{'L':4,'H':2,'rotation':1,'bin_types':[0,1],'perishable':0,'radioactive':1},
    14:{'L':2,'H':1,'rotation':1,'bin_types':[0,1],'perishable':0,'radioactive':1},
    15:{'L':2,'H':3,'rotation':1,'bin_types':[0,1],'perishable':0,'radioactive':1},
    16:{'L':2,'H':6,'rotation':1,'bin_types':[0,1],'perishable':0,'radioactive':1}     
     }
